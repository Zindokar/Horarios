...
namespace HorariosBack.Controllers
{
    ...
    public class SchedulesController : ControllerBase
    {
        ...
        public SchedulesController(horariosContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Schedules/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Schedule>> GetSchedule(uint id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutSchedule(uint id, Schedule schedule)
        {
            if (id != schedule.Id)
            {
                return BadRequest();
